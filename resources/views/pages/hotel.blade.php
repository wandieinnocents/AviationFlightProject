      ...
      <div class="hot-page2-alp-con">
        ...
        <div class="col-md-3 hot-page2-alp-con-left">
          ...
          <div class="hot-page2-alp-con-left-1">
            <h3>Top Hotels</h3> </div>
          <!--PART 2 : LEFT LISTINGS-->
          <div class="hot-page2-hom-pre hot-page2-alp-left-ner-notb">
            <ul>
              <!--LISTINGS-->
              @foreach($hotel_cats as $hotel)
              <li>
                <a href="#">
                  <div class="hot-page2-hom-pre-1 hot-page2-alp-cl-1-1"> <img src="{{ $hotel->image }}" alt=""> </div>
                  <div class="hot-page2-hom-pre-2 hot-page2-alp-cl-1-2">
                    <h5><a href="/hotel/{{ $hotel->id }}">{{ $hotel->name }}</a></h5> <span>{{ $hotel->location }}</span> </div>
              ...
              <div class="hot-page2-alp-r-list">
                <div class="col-md-3 hot-page2-alp-r-list-re-sp">
                  <a href="javascript:void(0);">
                    ...
                    <div class="hot-page2-hli-1"> <img src="{{ $hotel->image }}" alt=""> </div>
                    <!-- <div class="hom-hot-av-tic hom-hot-av-tic-list"> Available Rooms: 42 </div> -->
                  </a>
                </div>
                <div class="col-md-6">
                  <div class="hot-page2-alp-ri-p2"> <a href="/hotel/{{ $hotel->id }}"><h3>{{ $hotel->name }}</h3></a>
                    <ul>
                      <li>{{ $hotel->location }}</li>


                    </ul>
                    <p>About: {{  str_limit( $hotel->description, $limit = 120, $end = '..') }}</li></p>

                    <p>Tel: {{ $hotel->contact }}</li></p>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="hot-page2-alp-ri-p3">
                    ...
                    <span class="hot-list-p3-4">
                      <a href="/hotel/{{ $hotel->id }}" class="hot-page2-alp-quot-btn">VIEW DETAILS</a>
                    </span> </div>
                </div>
              </div>
              @endforeach
