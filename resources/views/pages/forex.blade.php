  ...
  <div class="container">
    <div class="row inner_banner inner_banner_3 bg-none">
      <div class="hot-page2-alp-tit">
        <h1>Forex Bureaus  on the platform </h1>
        <ul>
      ...
      <div class="hot-page2-alp-con">
        ...
        <div class="col-md-3 hot-page2-alp-con-left">
          ...
          <div class="hot-page2-alp-con-left-1">
            <h3>Top Forex Bureaus</h3> </div>
          <!--PART 2 : LEFT LISTINGS-->
          <div class="hot-page2-hom-pre hot-page2-alp-left-ner-notb">
            <ul>
              <!--LISTINGS-->
              @foreach($forexdesending as $forex)
              <li>
                <a href="#">
                  <div class="hot-page2-hom-pre-1 hot-page2-alp-cl-1-1"> <img src="{{ $forex->image }}" alt=""> </div>
                  <div class="hot-page2-hom-pre-2 hot-page2-alp-cl-1-2">
                    <h5><a href="/forexbureau/{{ $forex->id }}">{{ $forex->name }}</a></h5> <span>{{ $forex->location }}</span> </div>
              ...
              <div class="hot-page2-alp-r-list">
                <div class="col-md-3 hot-page2-alp-r-list-re-sp">
                  <a href="javascript:void(0);">
                    ...
                    <div class="hot-page2-hli-1"> <img src="{{ $forex->image }}" alt=""> </div>
                    <!-- <div class="hom-hot-av-tic hom-hot-av-tic-list"> Available Rooms: 42 </div> -->
                  </a>
                </div>
                <div class="col-md-6">
                  <div class="hot-page2-alp-ri-p2"> <a href="/forexbureau/{{ $forex->id }}"><h3>{{ $forex->name }}</h3></a>
                    <ul>
                      <li>{{ $forex->location }}</li>


                    </ul>
                    <p>About: {{  str_limit( $forex->description, $limit = 120, $end = '..') }}</li></p>

                    <p>Tel: {{ $forex->contact }}</li></p>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="hot-page2-alp-ri-p3">
                    ...
                    <span class="hot-list-p3-4">
                      <a href="/forexbureau/{{ $forex->id }}" class="hot-page2-alp-quot-btn">VIEW DETAILS</a>
                    </span> </div>
                </div>
              </div>
              @endforeach
